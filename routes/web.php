...
//ADMINISTRADOR
    ...
    //Route::get('/micmac/show', 'Admin\IndicadoresController@inicio')->name('indicadores.inicio');

    Route::get('micmacI','MicmacController@prueba')->name('MicmacP');
    Route::get('mactorI','MactorController@prueba')->name('MactorH');
    Route::get('morpholI','MorpholController@home')->name('MorpholH');
    Route::get('multipolI','MultipolController@home')->name('MultipolH');
    Route::get('smicI','SmicController@home')->name('SmicH');
